                      ...
                      <div class="row no-gutters w-100">
                        <div class="col-3">
                          ...
                          <div class="dropdown-item">
                            <a class="dropdown-link" href="{{ route('show-category', str_replace(" ", "-", $category['name'])) }}">
                        ...
                        <div class="col-4 h-100">
                          <div class="card border-0 mt-4 ml-2">
                            ...
                            <img src="{{ url('assets/user/images/'.(session()->get('categories'))[$i]['img_name']) }}" alt="Image Menu" class="card-img" style="height: 300px;">
                            <div class="card-img-overlay d-flex flex-column pt-6 pb-5">
                              <p class="text-white font-weight-600 text-center mb-0">
                                Blinds
                              </p>
                              <h3 class="text-white fs-40 text-center">{{ ucwords((session()->get('categories'))[$i]['name']) }}</h3>
                              <div class="mt-auto text-center">
                                <a href="{{ route('show-category', str_replace(" ", "-", (session()->get('categories'))[$i]['name'])) }}" class="btn btn-primary">shop
                                  now</a>
                              </div>
                            </div>
                          </div>
            ...
            <div class="col-2 d-flex justify-content-center align-items-center">
              <a class="navbar-brand mx-0 d-block"
                ...
                <img id="stickyLogo" src="{{ url('assets/user/images/logo.png') }}" alt="Furnitor"
                               class="sticky-logo"> --}}
                <img id="normalLogo" src="{{ url('assets/user/images/logo-blind-white.png') }}" alt="Furnitor"
                               class="normal-logo">
                <img id="stickyLogo" src="{{ url('assets/user/images/logo-blind.png') }}" alt="Furnitor"
                               class="sticky-logo">
              </a>
            </div>
        ...
        <div class="d-block d-xl-none">
          <nav class="navbar navbar-expand-xl px-0 py-2 py-xl-0 align-items-center w-100">
            ...
            <a class="navbar-brand d-inline-block mx-auto" href="{{ route('homepage') }}">
              <img src="images/logo-blind-white.png" alt="Furnitor"
                           class="normal-logo">
              <img src="images/logo-blind.png" alt="Furnitor"
                           class="sticky-logo">
            </a>
            <a href="#search-popup" data-gtf-mfp="true"
                     data-mfp-options='{"type":"inline","focus": "#keyword","mainClass": "mfp-search-form mfp-move-from-top mfp-align-top"}'
