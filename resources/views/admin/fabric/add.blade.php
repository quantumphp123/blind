      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('post-add-fabric')}} " role="form" id="quickForm" method="post"
              enctype="multipart/form-data">
              @csrf
              <div class="card-body pb-0">
                <div class="form-group">
                  <label for="exampleInputEmail1">Fabric Name</label>
                  <input type="text" name="name" class="form-control" placeholder="Enter Fabric Name">
                </div>
                <div class="form-group">
                  ...
                  <input type="file" name="files[]" class="form-input mt-1" id="exampleInputFile" placeholder="Choose Fabric Color Image"
                    multiple>
                  {{-- <label class="custom-file-label" for="exampleInputFile">Choose Fabric Color Image</label> --}}
                </div>
              </div>
              <!-- /.card-body -->
