...
<main id="content">
        ...
        <div class="d-flex flex-column justify-content-center bg-img-cover-center vh-100 custom-height-sm"
          ...
          <div class="d-flex flex-column h-100 justify-content-end pb-10 pb-lg-12">
            <div class="container container-xxl">
              ...
              <a href="#shopWithUs" class="btn btn-white text-uppercase letter-spacing-05" data-animate="fadeInUp">Shop
                Now</a>
            </div>
          </div>
        </div>
  ...
  <section class="pt-11 pt-lg-12 pb-lg-10" id="shopWithUs">
    <div class="container">
          ...
          <div class="col-sm-6 col-lg-3 mb-8" data-animate="fadeInUp">
            <div class="card border-0 hover-change-content product">
              <div class="card-img-top position-relative">
                <div style="background-image: url({{'/projects/blind/assets/user/images/'.$category['img_name']}})"
                ...
                <div
                  ...
                  <a href="{{ route('show-category', str_replace(" ", "-", $category['name'])) }}" data-toggle="tooltip" title="Preview"
              ...
              <div class="card-body px-0 pt-4 pb-0 d-flex align-items-end">
                <div class="mr-auto">
                  ...
                  <a href="{{ route('show-category', str_replace(" ", "-", $category['name'])) }}" class="font-weight-bold mt-1 d-block">{{ ucwords($category['name']) }}</a>
                </div>
              </div>
            </div>
          </div>
