      ...
      <form>
        <div class="row">
          ...
          <div class="col-sm-6 mb-4 form-group input-dimension">
            ...
            <input id="productWidth" class="col-sm-12" type="text" />
          ...
          <div class="col-sm-6 mb-4 form-group input-dimension">
            ...
            <input id="productDrop" class="col-sm-12" type="text" />
            <div class="font-italic" style="font-size:80% ;">Please Enter a dimension between 500 and 5500</div>
          </div>
          {{-- @endif --}}
          {{-- @if ($item['type'] == 'select')
          ...
          <div id="selectMaterial" class="col-sm-12 mb-4 form-group">
            ...
            <select id="sel" class="form-control col-sm-12" @if (count($fabrics) < 5)
        ...
        <div style="width:80%; margin:auto">
          ...
          <div id="renderDataHere mt-5">
            ...
            <div class="mb-10" id="" name="dawn">
              <div id="renderFabImgs" style="background-color: rgb(248, 252, 255)">
                <div class="row p-4">
