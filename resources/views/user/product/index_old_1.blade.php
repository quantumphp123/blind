            ...
            <div id="radio-btns" style="display:none ;" class="row mb-5">
              <div style="display:flex;">
                <div style="width:33.3%;">
                  ...
                  <div>
                    <select size="4" class="form-control w-75" name="sideWinder">
                ...
                <div style="width:33.3%;">
                  ...
                  <div>
                    <select size="5" class="form-control w-75" name="bottomRail">
                ...
                <div style="width:33.3%;">
                  ...
                  <div>
                    <select size="2" class="form-control w-75" name="roll">
              ...
              <div class="mt-3" style="display:flex;">
                <div style="width: 33.33%;">
                  ...
                  <div>
                    <select size="6" class="form-control w-75" name="chainMotor">
                ...
                <div style="width: 33.33%;">
                  ...
                  <div>
                    ...
                    <select size="2" class="form-control w-75" name="controlSide">
