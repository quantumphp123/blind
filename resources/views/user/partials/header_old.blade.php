                      ...
                      <div class="row no-gutters w-100">
                        ...
                        <div class="col-4 h-100">
                          <div class="card border-0 mt-4 ml-2">
                            ...
                            <img src="{{ url('assets/user/images/The-roller-blinds.jpeg') }}" alt="Image Menu" class="card-img" style="height: 300px;">
                            <div class="card-img-overlay d-flex flex-column pt-6 pb-5">
                              <p class="text-white font-weight-600 text-center mb-0">
                                Blinds
                              </p>
                              <h3 class="text-white fs-40 text-center">Roller Blinds</h3>
        ...
        <div class="d-block d-xl-none">
          <nav class="navbar navbar-expand-xl px-0 py-2 py-xl-0 align-items-center w-100">
            ...
            <a class="navbar-brand d-inline-block mx-auto" href="{{ route('homepage') }}">
              <img src="{{ url('assets/user/images/logo-blind-white.png') }}" alt="Blind Designers"
                           class="normal-logo" style="width: 80%">
              <img src="{{ url('assets/user/images/logo-blind.png') }}" alt="Blind Designers"
                           class="sticky-logo" style="width: 80%">
            </a>
            <a href="#search-popup" data-gtf-mfp="true"
                     data-mfp-options='{"type":"inline","focus": "#keyword","mainClass": "mfp-search-form mfp-move-from-top mfp-align-top"}'
