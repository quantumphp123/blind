      ...
      <form>
        <div class="row">
          ...
          <div class="col-sm-6 mb-4 form-group input-dimension">
            <label class="text-primary fs-16 font-weight-bold mb-3" for="productWidth">Width (mm)<sup class="text-danger">*</sup> </label>
            <input id="productWidth" type="text" />
            <div style="font-size:80% ;">Please Enter a dimension between 500 and 5500</div>
          </div>
          <div class="col-sm-6 mb-4 form-group input-dimension">
            <label class="text-primary fs-16 font-weight-bold mb-3" for="productDrop">Drop (mm)<sup class="text-danger">*</sup> </label>
          ...
          <div id="selectMaterial" class="col-sm-12 mb-4 form-group">
            ...
            <select id="sel" @if (count($fabrics) < 5)
              size="{{ count($fabrics) + 1 }}"
            @else
                size="5"
            @endif class="form-control  w-100">
              <option selected value="0">Choose an option</option>
              @foreach ($fabrics as $fabric)
              <option value="{{ $fabric['id'] }}">{{ ucwords($fabric['name']) }}</option>
              @endforeach
            </select>
          </div>
          {{-- <div id="selectMaterial" class="col-sm-12 mb-4 form-group">
                        ...
                        <div style="display: flex;">
                          ...
                          <label for="${element.id}">
                            <div style="padding: 5px;">
                              <span>
                                <img src="${imgURL}" style="height: 120px; width: 170px;" />
                              </span>
                            </div>
                            <div style="padding: 5px;">
                              <span>
