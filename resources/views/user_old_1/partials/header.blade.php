                    ...
                    <div class="container container-xxl">
                      <div class="row no-gutters w-100">
                        <div class="col-3">
                          ...
                          <div class="dropdown-item">
                            <a class="dropdown-link" href="{{ route('show-product', str_replace(" ", "-", $product['name'])) }}">
                              {{ strtoupper($product['name']) }}
                            </a>
                          </div>
                          @endforeach
                        ...
                        <div class="col-4 h-100">
                          <div class="card border-0 mt-4 ml-2">
                            ...
                            <img src="{{ url('assets/user/images/'.(session()->get('products'))[$i]['img_name']) }}" alt="Image Menu" class="card-img" style="height: 300px;">
                            <div class="card-img-overlay d-flex flex-column pt-6 pb-5">
                              <p class="text-white font-weight-600 text-center mb-0">
                                Blinds
                              </p>
                              <h3 class="text-white fs-40 text-center">{{ ucwords((session()->get('products'))[$i]['name']) }}</h3>
