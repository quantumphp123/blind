...
Route::get('category/{name}',[UserController::class,'show_category'])->name('show-category');
...
Route::get('account-order-history',[UserController::class,'account_order_history'])->name('account-order-history');
...
Route::get('product/{name}',[UserController::class,'show_product'])->name('show-product');
Route::get('get-fabric-details',[UserController::class,'get_fabric_details'])->name('get-fabric-details');
Route::get('get-product-details',[UserController::class,'get_product_details'])->name('get-product-details');
...
Route::group(['middleware'=>['adminBasicAuth']],function(){
    ...
    Route::get('fabrics', [App\Http\Controllers\AdminController::class, 'view_fabrics'])->name('view-fabrics');
    Route::get('fabric-details/{name}', [App\Http\Controllers\AdminController::class, 'view_fabric_details'])->name('view-fabric-details');
    Route::get('fabric-details/{name}/add-color', [App\Http\Controllers\AdminController::class, 'view_add_image'])->name('view-add-image');
    Route::get('delete-image/{name}/{id}', [App\Http\Controllers\AdminController::class, 'delete_image'])->name('delete-image');
    Route::get('fabrics/add-fabric', [App\Http\Controllers\AdminController::class, 'add_fabric'])->name('add-fabric');
    Route::get('fabrics/delete-fabric/{name}', [App\Http\Controllers\AdminController::class, 'delete_fabric'])->name('delete-fabric');
    Route::post('add-fabric', [App\Http\Controllers\AdminController::class, 'post_add_fabric'])->name('post-add-fabric');
    Route::post('add-color', [App\Http\Controllers\AdminController::class, 'post_add_image'])->name('post-add-image');
    Route::get('products', [App\Http\Controllers\AdminController::class, 'view_products'])->name('view-products');
    Route::get('add-fabric/{name}', [App\Http\Controllers\AdminController::class, 'add_fabric_in_product'])->name('add-fabric-in-product');
    Route::get('remove-fabric/{name}', [App\Http\Controllers\AdminController::class, 'remove_fabric'])->name('remove-fabric');
    Route::post('remove-fabric', [App\Http\Controllers\AdminController::class, 'post_remove_fabric'])->name('post-remove-fabric');
    Route::post('add-fabric-in-product', [App\Http\Controllers\AdminController::class, 'post_add_fabric_in_product'])->name('post-add-fabric-in-product');
